	...
	loadSite: function(){
      ...
      // console.log(e);
        ...
        if (ractive.get('siteType') === 'existing') {
          ...
          ractive.set('activeSite.activeSite.currentreefarea_ha', 0);
  ...
  calculateOneOysterFilt: function (oysterType, length, length2RefName, temp) {
    ...
    $('body').on('click', function (e) {
        ...
        currentFiltration: function () {
          ...
          if ((this.get('activeSite.currentculldensity_ind_m2') !== null) || (this.get('activeSite.currentmarketdensity_ind_m2') !== null)) {
